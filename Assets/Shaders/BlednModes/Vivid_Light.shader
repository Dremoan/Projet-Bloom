...
Shader "BlendModes/Vivid_Light"
{
	Properties
	{
		_MainTex ("Sprite Texture", 2D) = "white" {}
		_Color ("Tint", Color) = (1,1,1,1)
		_Opacity ("Opacité", range(0,100)) =  100
	}
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 Vivid_Light (fixed4 a, fixed4 b)
			{ 
			...
			fixed4 ComputeFragment (VertexOutput vertexOutput) : SV_Target
			{
				...
				return Vivid_Light(grabColor, color);
			}
